    ...
    return (
      ...
      >
        ...
        <TableRow align="center">
          ...
          <TableCell className={classes.th} component="th" scope="row"  padding="none" align="center">Start Date</TableCell>
          <TableCell className={classes.th} component="th" scope="row"  padding="none" align="center">End Date</TableCell>
        </TableRow>
        </TableHead>
        <TableBody>
  ...
  return (
    <div align = "center" className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <BlankArea />
        <h3>Greek page under implementation</h3>
      </Paper>
    </div>
  );
}
